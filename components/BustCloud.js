...
export default function BustCloud() {
  return (
    <Canvas
...
function Bust(props) {
  ...
  const levels = useGLTF(['/assets/models/bust-1-d.glb', '/assets/models/bust-2-d.glb', '/assets/models/bust-3-d.glb', '/assets/models/bust-4-d.glb'])
